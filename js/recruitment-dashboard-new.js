...
function updateChannelPieChart(channelData) {
    ...
    const backgroundColors = [
        'rgba(91, 155, 213, 0.85)',   // 柔和蓝 - 招聘微信号
        'rgba(112, 173, 71, 0.85)',   // 柔和绿 - 抖音
        'rgba(255, 192, 0, 0.85)',    // 柔和黄 - 小红书
        'rgba(237, 125, 49, 0.85)',   // 柔和橙 - 公司招聘栏
        'rgba(128, 100, 162, 0.85)',  // 柔和紫 - 微信公众号
        'rgba(75, 172, 198, 0.85)',   // 柔和青
        'rgba(192, 192, 192, 0.85)'   // 柔和灰 - 其他
    ];
