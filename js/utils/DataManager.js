...
class RecruitmentDataManager {
    ...
    async syncFromApplications(lastSyncTime = null) {
        try {
            ...
            return {
                success: true,
                message: `同步完成：新增 ${insertedCount} 条，更新 ${updatedCount} 条，清理 ${cleanupResult.deletedCount || 0} 条已取消记录`,
